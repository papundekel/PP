...
public:
    ...
    {}
    constexpr function_info(type_t<R(P...) volatile&>) noexcept
        : function_info(cv_qualifier::Volatile, ref_qualifier::lvalue, false)
    {}
    constexpr function_info(type_t<R(P...) const volatile&>) noexcept
        : function_info(cv_qualifier::const_volatile,
    ...
    {}
    constexpr function_info(type_t<R(P...) volatile&&>) noexcept
        : function_info(cv_qualifier::Volatile, ref_qualifier::rvalue, false)
    {}
    constexpr function_info(type_t<R(P...) const volatile&&>) noexcept
        : function_info(cv_qualifier::const_volatile,
    ...
    {}
    constexpr function_info(type_t<R(P...) const volatile noexcept>) noexcept
        : function_info(cv_qualifier::const_volatile, ref_qualifier::none, true)
    {}
...
PP_CIA get_function_info = compose(
    [](auto&& t)
    {
