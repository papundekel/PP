...
namespace PP
{
	namespace detail
	{
		constexpr decltype(auto) map_arguments_element_helper(auto maps, concepts::value auto i)
		{
		...
		template <auto... I>
		constexpr decltype(auto) map_arguments_helper(auto& f, auto maps, value_sequence<I...>, auto&&... args)
		{
			return f(map_arguments_element_helper(maps, value<I>)(PP_FORWARD(args))...);
		}
	}
