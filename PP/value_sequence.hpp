...
namespace PP
{
	...
	{
		template <auto... I>
		constexpr auto chain_value_sequence(value_sequence<I...>, concepts::value auto even) noexcept
		{
		...
		constexpr auto make_value_sequence(concepts::value auto i)
		{
			if constexpr (PP_GET_VALUE(i) == 0)
				...
				return chain_value_sequence(make_value_sequence(i / value_2), i % value_2 == value_0);
		}
	}
