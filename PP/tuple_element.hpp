...
namespace PP
{
	namespace detail
	{
		...
		requires tuple_concept_element_member<decltype(i), decltype(t)>
		{
			return PP_FORWARD(t).element(i);
		}
		constexpr auto tuple_element_helper(concepts::value auto i, auto&& t)
		requires tuple_concept_element_nonmember<decltype(i), decltype(t)>
		{
			return element_implementation(i, PP_FORWARD(t));
		}
		constexpr auto tuple_element_helper(concepts::value auto i, auto&& t)
		requires tuple_concept_element_recursive<decltype(i), decltype(t)>
		{
